...
***************************************************************************************************************/
        private static void Excercise1()
        {
            ...
            Animal cow = AnimalFactory.GetAnimal(AnimalEnum.Cow);           
            farm.Enter(cow);

            Animal hen = AnimalFactory.GetAnimal(AnimalEnum.Hen);
            farm.Enter(hen);

            Animal horse = AnimalFactory.GetAnimal(AnimalEnum.Horse);
            farm.Enter(horse);

            Animal sheep = AnimalFactory.GetAnimal(AnimalEnum.Sheep);
            farm.Enter(sheep);
